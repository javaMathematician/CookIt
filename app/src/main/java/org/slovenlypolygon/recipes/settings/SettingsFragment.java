...
public class SettingsFragment extends SimpleCookItFragment {
    private static final String HTML = "<!DOCTYPE html>\n" +
            ...
            "\n" +
            "        <h3>Дисклеймер</h3>\n" +
            "        <p>Все данные взяты с https://www.eda.ru. Приложение никак не монетизируется, не показывает рекламу и написано с целью популяризации сайта и рецептов на нём на некоммерческой основе.\n</p>" +
            "    </body>\n" +
            "</html>";
